...
/* package category-0.2.1.0 */
#ifndef VERSION_category
#define VERSION_category "0.2.1.0"
#endif /* VERSION_category */
#ifndef MIN_VERSION_category
#define MIN_VERSION_category(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 1)
#endif /* MIN_VERSION_category */
...
#define CURRENT_COMPONENT_ID "func2-0.1.0.0-9YQPZvvi3PjJl8wiAsdCxm-func2"
